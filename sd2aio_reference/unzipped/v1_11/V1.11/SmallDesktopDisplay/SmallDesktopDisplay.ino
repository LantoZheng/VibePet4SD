...
String cityCode = "101250101";  //天气城市代码 长沙:101250101株洲:101250301衡阳:101250401杭州:101210101
int LCD_BL_PWM = 20;//屏幕亮度0-100
int tempnum = 0;   //温度百分比
int huminum = 0;   //湿度百分比
int tempcol =0xffff;
int humicol =0xffff;
...
void loading(byte delayTime)//绘制进度条
{
  ...
  clk.drawRightString("SDD "+Version,180,60,2);
...
void getCityCode(){
  Serial.println("getCityCode_begin");
  ...
  //关闭ESP8266与服务器连接
  httpClient.end();
  Serial.println("getCityCode_end");
}
...
// 获取城市天气
void getCityWeater(){
 Serial.println("getCityWeater_begin");
 ...
 Serial.println(cityCode);
  ...
  //关闭ESP8266与服务器连接
  httpClient.end();
  Serial.println("getCityWeater_end");
}
